...
using static Drill4J.Injection.ProfilerProxy;
using System.IO;
    ...
    public class ProfilerProxyGenerator
    {
        ...
        */
        ...
        public void InjectTo(AssemblyDefinition assembly)
        {
			...
			var Ldstr2 = il_ProfilerProxy_cctor_.Create(OpCodes.Ldstr, @"d:\Projects\EPM-D4J\!!_exp\Injector.Net\Plugins.Logger\bin\Debug\netstandard2.0\Plugins.Logger.dll");
			...
			var Ldstr11 = il_ProfilerProxy_cctor_.Create(OpCodes.Ldstr, "Plugins.Logger.LoggerPlugin");
			...
			var Ldstr15 = il_ProfilerProxy_cctor_.Create(OpCodes.Ldstr, "Process");
            ...
            #endregion
            #region Constructor: ProfilerProxy()
