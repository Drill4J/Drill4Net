...
namespace Cecilifier.Runtime
{
    ...
    public struct PrivateCoreLibFixer
    {
        ...
        static PrivateCoreLibFixer()
        {
            ...
            // in most platforms, referencing System.Object and other types ends up adding a reference to System.Private.CoreLib 
            // (note that in these platforms, System.Runtime has type forwarders for these types).
