...
namespace Drill4Net.Target.Comon.Tests
{
    ...
    public class InjectTargetTests
    {
        ...
        public void Parent_Child_Ok(object[] args, bool isAsync, bool ignoreEnterReturns, 
        ...
        internal class SourceData
        {
            ...
            internal static IEnumerable ParentChild
            {
                get
                {
                    ...
                    yield return GetCase(new object[] { false }, true, true, (GetInfo(_target.AsyncLambda), new List<string> { "Else_59" }));
                    yield return GetCase(new object[] { true }, true, true, (GetInfo(_target.AsyncLambda), new List<string> { "If_18" }));
