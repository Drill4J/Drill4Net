...
{
    [CliCommandAttribute(ConfiguratorConstants.CONTEXT_TARGET, ConfiguratorConstants.COMMAND_ACTIVE)]
    public class TargetActiveCommand : AbstractConfiguratorCommand
    {
        ...
        public override Task<(bool done, Dictionary<string, object> results)> Process()
        {
            ...
            var res = _cmdHelper.ActivateConfig<InjectionOptions>(CoreConstants.SUBSYSTEM_INJECTOR, dir, _desc);
        ...
        {
            return HelpHelper.GetActiveConfigText(CoreConstants.SUBSYSTEM_INJECTOR, true, RawContexts, "targetA");
        }
    }
}
