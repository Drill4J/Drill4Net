...
{
    [CliCommandAttribute(ConfiguratorConstants.CONTEXT_RUNNER, ConfiguratorConstants.COMMAND_DELETE)]
    public class TestRunnerDeleteCommand : AbstractConfiguratorCommand
    {
        ...
        {
            return $"Delete the specified {CoreConstants.SUBSYSTEM_TEST_RUNNER} config.";
        }
