namespace Drill4Net.Agent.Abstract
{
    ...
    {
        //topics
        public const string TEST_TOPIC_TESTS_ADD = "ADD_TESTS";

        //routes
        public const string TEST_ROUTE_ACTION = "dispatch-action";

        //metadata
        public const string TEST_ASSEMBLY_PATH = "AssemblyPath";
