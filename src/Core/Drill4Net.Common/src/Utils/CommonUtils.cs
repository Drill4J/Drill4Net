...
// DON'T USE versioning here (CommonUtils.AssemblyFileGitVersion & CommonUtils.AssemblyProductVersion) -> Action will fail on the GitHub
...
namespace Drill4Net.Common
{
    ...
    public static class CommonUtils
    {
        ...
        public static Assembly TryResolveAssembly(string dir, string context, ResolveEventArgs args, AssemblyResolver resolver, ILogger log)
        {
            ...
            log?.LogDebug($"{context}: assembly [{name}] was not resolved");
        ...
        /// <summary>
        /// Read environment variable from system
        /// </summary>
        /// <param name="var">Name of the variable</param>
        /// <param name="source">For Docker use default (Process)</param>
        /// <returns></returns>
        public static string ReadEnvironmentVar(string var, EnvironmentVariableTarget source = EnvironmentVariableTarget.Process)
        {
            return Environment.GetEnvironmentVariable(var, source);
        }
