...
using Conf = Drill4Net.Compressor.Benchmarks.CompressorConfigurator;
...
namespace Drill4Net.Compressor.Benchmarks.Helpers
{
    internal static class ResultReporter
    {
        ...
        internal static void PrintAndLogResult(List<TestResult> testResults, IBenchmarkLogger logger)
        {
            ...
            var resultsOrdered = testResults
                .OrderBy(c => c.CompressorType)
                .ThenBy(l => l.CompressLevel)
                .ThenBy(t => t.DataType)
                .ToList();
            ...
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L03_HC), nameof(CompressionLevel.Optimal), ModelTypes.Medium);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L03_HC), nameof(CompressionLevel.Optimal), ModelTypes.Complex);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L03_HC), nameof(CompressionLevel.Optimal), ModelTypes.InjectedSolution);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L10_OPT), nameof(CompressionLevel.Optimal), ModelTypes.Medium);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L10_OPT), nameof(CompressionLevel.Optimal), ModelTypes.Complex);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L10_OPT), nameof(CompressionLevel.Optimal), ModelTypes.InjectedSolution);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L09_HC), nameof(CompressionLevel.Optimal), ModelTypes.Medium);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L09_HC), nameof(CompressionLevel.Optimal), ModelTypes.Complex);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L09_HC), nameof(CompressionLevel.Optimal), ModelTypes.InjectedSolution);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L00_FAST), nameof(CompressionLevel.Fastest), ModelTypes.Medium);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L00_FAST), nameof(CompressionLevel.Fastest), ModelTypes.Complex);
            AddToRelativeTable(ref tableRelative, resultsOrdered, nameof(LZ4Level.L00_FAST), nameof(CompressionLevel.Fastest), ModelTypes.InjectedSolution);
            tableRelative.Write();
