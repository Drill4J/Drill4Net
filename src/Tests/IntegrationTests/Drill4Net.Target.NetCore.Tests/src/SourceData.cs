    ...
    internal class SourceData
    {
        ...
        internal static IEnumerable Simple
        {
            get
            {
                ...
                //yield return GetCase(GetInfo(_target50.Switch_Relational), new object[] { -5 }, new List<string> { "Else_8", "If_21" });
                //yield return GetCase(GetInfo(_target50.Switch_Relational), new object[] { 5 }, new List<string> { "Else_8", "If_25" });
                //yield return GetCase(GetInfo(_target50.Switch_Relational), new object[] { 10 }, new List<string> { "If_15", "If_31" });
                //yield return GetCase(GetInfo(_target50.Switch_Relational), new object[] { 100 }, new List<string> { "If_15", "If_39" });

                //yield return GetCase(GetInfo(_target50.Switch_Logical), new object[] { -5 }, new List<string> { "If_15" });
                //yield return GetCase(GetInfo(_target50.Switch_Logical), new object[] { 5 }, new List<string> { "Else_8", "If_20" });
                //yield return GetCase(GetInfo(_target50.Switch_Logical), new object[] { 10 }, new List<string> { "Else_8", "If_24" });
                #endregion
                #region Elvis
