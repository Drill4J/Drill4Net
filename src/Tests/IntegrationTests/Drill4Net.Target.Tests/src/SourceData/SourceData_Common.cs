    ...
    internal class SourceData_Common
    {
        ...
        internal static IEnumerable Simple
        {
            get 
            {
                ...
                yield return GetCase(GetInfo(_target.Elvis_Null), Array.Empty<object>(), new List<string> { "Else_6" });

                yield return GetCase(GetInfo(_target.Elvis_Sequence_NotNull), Array.Empty<object>(), new List<string> { "If_14", "If_27" });
                yield return GetCase(GetInfo(_target.Elvis_Sequence_Null), Array.Empty<object>(), new List<string> { "Else_6" });

                yield return GetCase(GetInfo(_target.Elvis_Double_NotNull), Array.Empty<object>(), new List<string>());
                yield return GetCase(GetInfo(_target.Elvis_Double_Null), Array.Empty<object>(), new List<string> { "Else_7" });
                #endregion
                #region Linq
                ...
                yield return GetCase(GetInfo(_target.Goto_Statement_Cycle_Out), new object[] { false }, new List<string> { "If_19", "Cycle_35", "If_19", "Cycle_35" }).SetCategory(CATEGORY_MISC);
        ...
        internal static IEnumerable Parented
        {
            get
            {
                ...
                yield return GetCase(Array.Empty<object>(), true, true,
                    ...
                    new TestInfo(GetSourceFromFullSig(_target, "System.Collections.Generic.IAsyncEnumerable`1<System.Int32> Drill4Net.Target.Common.InjectTarget::GenerateSequenceAsync()"), false, new List<string> { "Else_24", "Else_24", "Else_24", "If_36", "If_36" }, true));

                yield return GetCase(Array.Empty<object>(), true, true,
                    new TestInfo(GetInfo(_target.Async_Stream_Cancellation), new List<string> { "If_76" }),
                    new TestInfo(GetSourceFromFullSig(_target, "System.Collections.Generic.IAsyncEnumerable`1<System.Int32> Drill4Net.Target.Common.InjectTarget::GenerateSequenceWithCancellationAsync(System.Threading.CancellationToken)"), false, new List<string> { "Else_24", "Else_24", "Else_24" }, true));
                ...
                //yield return GetCase(new object[] { false }, true, true, new TestInfo(GetInfo(_target.Async_Linq_NonBlocking), new List<string>()), new TestInfo(GetInfo(_target.GetDataForAsyncLinq), new List<string>()), new TestInfo(GetInfo(_target.ProcessElement), new List<string>())).Ignore(TestConstants.INFLUENCE);
                ...
                yield return GetCase(new object[] { false },
                    ...
                    new TestInfo(GetSourceFromFullSig(_target, "System.Boolean Drill4Net.Target.Common.DynamicDictionary::TrySetMember(System.Dynamic.SetMemberBinder,System.Object)"), false, new List<string>()),
                    new TestInfo(GetSourceFromFullSig(_target, "System.Boolean Drill4Net.Target.Common.DynamicDictionary::TryGetMember(System.Dynamic.GetMemberBinder,System.Object&)"), false, new List<string>()));
                ...
                yield return GetCase(Array.Empty<object>(), new TestInfo(GetInfo(_target.Disposable_Using_Last_Exception), new List<string> { "Throw_11" })); //in net50 was "Throw_10"

                yield return GetCase(new object[] { false }, new TestInfo(GetInfo(_target.Disposable_Using_Exception), new List<string>()));
                yield return GetCase(new object[] { true }, new TestInfo(GetInfo(_target.Disposable_Using_Exception), new List<string> { "If_16", "Throw_21" })); //in net50 was "If_15", "Throw_20"
                ...
                yield return GetCase(new object[] { (ushort)17 }, true,
                        ...
                        new TestInfo(GetSourceFromFullSig(_target, "System.Void Drill4Net.Target.Common.Finalizer::Finalize()"), true, new List<string> { "If_10", "If_33" }, true)); //in net5 was "If_31", "If_8"

                //still not work togeteher with previous call
                yield return GetCase(new object[] { (ushort)18 }, true,
                        new TestInfo(GetInfo(_target.Disposable_Finalizer), new List<string>()),
                        new TestInfo(GetSourceFromFullSig(_target, "System.Void Drill4Net.Target.Common.Finalizer::Finalize()"), true, new List<string> { "Else_12", "If_30" }, true)).Ignore(TestConstants.INFLUENCE);
                #endregion
                #region Misc
                ...
                yield return GetCase(Array.Empty<object>(), true,
                    new TestInfo(GetInfo(_target.Enumerator_Implementation), new List<string> { "Cycle_21", "Cycle_21", "Cycle_21", "Cycle_21" }),
                    new TestInfo(GetSourceFromFullSig(_target, "System.Collections.Generic.IEnumerator`1<System.String> Drill4Net.Target.Common.StringEnumerable::GetEnumerator()"), false, new List<string>()),
                    new TestInfo(GetInfo(_strEnumerator.MoveNext), new List<string> { "Else_22", "Else_22", "Else_22", "Else_22", "If_16" }),
                    new TestInfo(GetSourceFromFullSig(_target, "System.String Drill4Net.Target.Common.NotEmptyStringEnumerator::get_Current()"), false, new List<string> { "Else_6", "Else_6", "Else_6", "Else_6" }),
                    new TestInfo(GetSourceFromFullSig(_target, "System.Void Drill4Net.Target.Common.NotEmptyStringEnumerator::Dispose()"), false, new List<string>()))
                    .SetCategory(CATEGORY_MISC);
