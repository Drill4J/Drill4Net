    ...
    public class CommonSourceData
    {
        ...
        internal static IEnumerable Simple
        {
            get 
            {
                ...
                #endregion
                #region Cycle
                yield return GetCase(GetInfo(Target.Cycle_Do), new object[0], new List<string> { "If_10" }).Ignore("Not realzed proper injection");
        ...
        internal static IEnumerable Parented
        {
            get
            {
                ...
                #region Async/await
#if !NET461
                yield return GetCase(new object[0], true, true,
                ...
                yield return GetCase(new object[0], true,
